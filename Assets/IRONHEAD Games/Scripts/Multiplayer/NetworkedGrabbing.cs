...
public class NetworkedGrabbing : MonoBehaviourPunCallbacks, IPunOwnershipCallbacks
{
    ...
    void Start()
    {
        ...
        //Debug.Log(gameObject.GetComponent<XRGrabInteractable>().interactionLayers.value);
    }

    // Update is called once per frame
    void Update()
    {
        //We change the layer of 
        ...
        else
        {
            ...
            gameObject.layer = 8; //Change the layer back to OffHand
        }
    }
    ...
    {
        Debug.Log("Grabbed");
        m_photonView.RPC("StartNetworkedGrabbing", RpcTarget.All);
    ...
    {
        Debug.Log("Released");
        m_photonView.RPC("StopNetworkedGrabbing", RpcTarget.All);
    }
