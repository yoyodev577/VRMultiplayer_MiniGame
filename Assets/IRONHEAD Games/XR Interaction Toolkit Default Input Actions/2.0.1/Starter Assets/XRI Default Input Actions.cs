...
//     version 1.3.0
//     from Assets/IRONHEAD Games/XR Interaction Toolkit Default Input Actions/2.0.1/Starter Assets/XRI Default Input Actions.inputactions
//
...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        },
        {
            ...
            ""actions"": [
                ...
                {
                    ""name"": ""UI Switcher Action"",
                    ""type"": ""Button"",
                    ""id"": ""f24298e2-bb30-4e35-8527-1a594f86b16e"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""1bb54e43-b577-4d71-9746-d9b304b3c234"",
                    ""path"": ""<XRController>{LeftHand}/primaryButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                    ""action"": ""UI Switcher Action"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
        ...
        {
            ""name"": ""UI Menu"",
            ""id"": ""d9801263-2f38-4d1c-aa48-796fec81d3b7"",
            ""actions"": [
                {
                    ""name"": ""Activate UI Menu"",
                    ""type"": ""Button"",
                    ""id"": ""464e8b75-79ca-4f96-9ff8-3b0f49621c95"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""83e6e5c6-400b-4e91-aea9-f00f9aae3cdd"",
                    ""path"": ""<XRController>{RightHand}/primaryButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Generic XR Controller"",
                    ""action"": ""Activate UI Menu"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHandInteraction_UISwitcherAction = m_XRILeftHandInteraction.FindAction("UI Switcher Action", throwIfNotFound: true);
        ...
        m_UIMenu_ActivateUIMenu = m_UIMenu.FindAction("Activate UI Menu", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_XRILeftHandInteraction_UISwitcherAction;
    public struct XRILeftHandInteractionActions
    {
        ...
        public InputAction @UISwitcherAction => m_Wrapper.m_XRILeftHandInteraction_UISwitcherAction;
        ...
        public void SetCallbacks(IXRILeftHandInteractionActions instance)
        {
            if (m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface != null)
            {
                ...
                @UISwitcherAction.started -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnUISwitcherAction;
                @UISwitcherAction.performed -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnUISwitcherAction;
                @UISwitcherAction.canceled -= m_Wrapper.m_XRILeftHandInteractionActionsCallbackInterface.OnUISwitcherAction;
            }
            ...
            if (instance != null)
            {
                ...
                @UISwitcherAction.started += instance.OnUISwitcherAction;
                @UISwitcherAction.performed += instance.OnUISwitcherAction;
                @UISwitcherAction.canceled += instance.OnUISwitcherAction;
            }
        }
    }
    ...
    private readonly InputAction m_UIMenu_ActivateUIMenu;
    public struct UIMenuActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public UIMenuActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @ActivateUIMenu => m_Wrapper.m_UIMenu_ActivateUIMenu;
        ...
        public void SetCallbacks(IUIMenuActions instance)
        {
            ...
            {
                @ActivateUIMenu.started -= m_Wrapper.m_UIMenuActionsCallbackInterface.OnActivateUIMenu;
                @ActivateUIMenu.performed -= m_Wrapper.m_UIMenuActionsCallbackInterface.OnActivateUIMenu;
                @ActivateUIMenu.canceled -= m_Wrapper.m_UIMenuActionsCallbackInterface.OnActivateUIMenu;
            }
            m_Wrapper.m_UIMenuActionsCallbackInterface = instance;
            if (instance != null)
            {
                @ActivateUIMenu.started += instance.OnActivateUIMenu;
                @ActivateUIMenu.performed += instance.OnActivateUIMenu;
                @ActivateUIMenu.canceled += instance.OnActivateUIMenu;
            }
        }
    }
    ...
    public interface IXRILeftHandInteractionActions
    {
        ...
        void OnUISwitcherAction(InputAction.CallbackContext context);
    }
    ...
    {
        void OnActivateUIMenu(InputAction.CallbackContext context);
    }
}
