...
public class PlayerNetworkSetup_FinalIK : MonoBehaviour
{
    ...
    public GameObject AvatarSkinnedMeshRenderer;
    ...
    private void Awake()
    {
        ...
        AvatarSkinnedMeshRenderer.SetActive(false);
    ...
    private void InitiateLocal()
    {
        ...
        //So, we delay the rendering of the human avatar to gain performance.
        Invoke("EnableRenderingForAvatar", 0.0f);
    ...
    {
        AvatarSkinnedMeshRenderer.SetActive(true);
    }
}
